    ...
    <div className="flex flex-col gap-5 justify-center">
      ...
      <div className="flex gap-10 flex-col sm:flex-row">
        <div className="w-[300px]">
          ...
          <CardDescription>
            During this call, we aim to explore potential avenues for parternship, promotional opportunities, or any other mean through which we can contirbute to the success of your company
          </CardDescription>
        </div>
        <div>
          <Calendar 
            ...
            >
              <Card
                ...
                className={cn(
                  ...
                  "px-10 py-4",
                  bookings && bookings.some(
                    (booking) => 
                      `${booking.date.getDate()}/${booking.date.getMonth()}` === `${date?.getDate()}/${date?.getMonth}` && 
