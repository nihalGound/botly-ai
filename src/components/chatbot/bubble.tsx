import { cloudianryCofig, cn, extractUUIDFromString, getMonthName } from '@/lib/utils'
        ...
        <div className={cn(
            ...
            {image ? (
                <div className="relative aspect-square">
                    <Image
                        src={`https://res.cloudinary.com/${cloudianryCofig.cloud_name}/image/upload/f_auto,q_auto/${image[0]}`}
                        fill
                        alt="image"
                    />
                </div>
