...
import { useEmailMarketing } from '@/hooks/email-maketing/use-marketing'
      ...
      <div>
        <div className="flex gap-3 justify-start md:justify-end">
          ...
          <Modal
            ...
            description="Add your customers and create a marketing capaign"
            trigger={
          ...
          {campaign &&
            campaign.map((camp, i) => (
              <Card
                ...
                onClick={() => onnSelectCampaign(camp.id)}
              >
                  ...
                  <CardContent className="p-0 flex flex-col items-center gap-3">
                    ...
                    <div className="flex w-full justify-between items-center">
                      ...
                      <div className="flex gap-3">
                        <Modal
                          title="Edit Email"
                          description="This email will be sent to campaign memers"
                          trigger={
