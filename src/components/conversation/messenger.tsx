...
const Messenger = (props: Props) => {
    ...
    return (
        <div className="flex-1 flex flex-col h-0 relative">
            <div className="flex-1 h-0 w-full flex flex-col md:pl-4">
                <Loader loading={loading}>
                    <div
                        ref={messageWindowRef}
                        className="w-full flex-1 h-0 flex flex-col gap-3 py-5 chat-window overflow-y-auto"
                    >
                        {chats.length ? (
                            chats.map((chat) => (
                                <Bubble
            ...
            >
                <div className="flex justify-between">
                    <Input
                        ...
                        className="focus-visible:ring-0 flex-1 p-0 focus-visible:ring-offset-0 bg-muted rounded-none outline-offset-0 border-none"
                    />
                    <Button
                        type="submit"
                        className="mt-3 px-7"
